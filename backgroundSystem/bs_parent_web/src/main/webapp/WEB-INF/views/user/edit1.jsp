					...
					<div class="panel-body">
						<form id="userfrom" role="form">
							<div class="form-group">
								<label >登陆账号</label> <input
									type="text" class="form-control" id="loginacct" value="${user.userName}"
									placeholder="请输入登陆账号">
							</div>
							<div class="form-group">
								<label >用户名称</label> <input
									type="text" class="form-control" id="username" value="${user.userName}"
									placeholder="请输入用户名称">
							</div>
							<div class="form-group">
								<label >邮箱地址</label> <input type="email"
									class="form-control" id="loginpwd" value="${user.password}" placeholder="请输入邮箱地址">
