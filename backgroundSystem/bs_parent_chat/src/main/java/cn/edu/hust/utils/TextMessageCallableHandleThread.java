...
public class TextMessageCallableHandleThread implements Callable<String> {

    private TextMessage textMessage;

    public TextMessageCallableHandleThread(){

    }

    public TextMessageCallableHandleThread(TextMessage textMessage){
